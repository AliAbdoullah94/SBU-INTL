//Apply
export const degrees = ['High School', 'Bachelor', 'Master'];
export const degreesToApp = ['Bachelor', 'Master', 'PHD'];
export const jobs = ['None', 'designer', 'development', 'product', 'other'];
